 ...
 */
class ClassAirMethaneMQ4 extends ClassMiddleSensor {
    /**
     * @constructor
    ...
    constructor(_opts, _sensor_props) {
		...
		this._Sensor = require('BaseClassMQX').connect({dataPin: _opts.pin1, heatPin: _opts.pin2, model: 'MQ4', r0: _opts.baseline});
        this._MinPeriod = 250;
        this._UsedChannels = [];
        this._Interval;
        this._CanRead = true;
